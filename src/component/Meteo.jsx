    ...
    return (
        <div className='meteoAll'>
            ...
            <div className='meteoEncadre'>
                <img alt="Mars Helicopter to Begin New Demo Phase" src="https://mars.nasa.gov/system/resources/detail_files/25790_First_selfie-1200.gif" className="meteoRover" />
            </div>
